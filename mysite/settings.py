...
SECRET_KEY = 'django-insecure-fg=&pevd(*(-aiwfuy!@!6j(0(or#p8%%sj#s10hwb2x-$wet6'
...
CACHES = {
    'default': {
        'BACKEND': 'django.core.cache.backends.locmem.LocMemCache',  # or your preferred cache backend
