# Generated by Django 5.1.7 on 2025-04-15 05:04
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('issuer', models.URLField(help_text='Issuer dari Tool Provider, misalnya https://moodle.example.com', unique=True)),
                ('client_id', models.CharField(help_text='Client ID dari Tool Provider', max_length=255, unique=True)),
                ...
                ('deployment_id', models.CharField(help_text='Deployment ID', max_length=255)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text="Nama alat, misalnya 'Kuis Moodle'", max_length=255)),
                ...
                ('max_grade', models.DecimalField(blank=True, decimal_places=2, help_text='Nilai maksimum, max 100', max_digits=5, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('assessment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='lti_tools', to='courses.assessment')),
                ('platform_config', models.ForeignKey(help_text='Konfigurasi platform LTI yang digunakan', on_delete=django.db.models.deletion.CASCADE, related_name='tools', to='courses.ltiplatformconfiguration')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tiktok', models.CharField(blank=True, max_length=200, null=True, verbose_name='tiktok')),
                ...
                ('name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='partner_univ', to='authentication.universiti')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='replies', to='courses.sospost')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
