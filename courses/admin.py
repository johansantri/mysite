...
from . import models 
from .models import Partner,Universiti,GradeRange, Instructor, Category, Course, TeamMember, Section, Material,Question, Choice, Score, AttemptedQuestion,Assessment
