...
urlpatterns = [
    ...
    path("enrollments/export/", views.export_enrollments_csv, name="export_enrollments_csv"),
    path('reports/course-ratings/', views.partner_course_ratings, name='partner_course_ratings'),
    path('org-partner/', views.partner_list_view, name='partner_list'),
    ...
    path('partner/comments/delete/<int:comment_id>/', views.delete_comment, name='delete_comment'),
